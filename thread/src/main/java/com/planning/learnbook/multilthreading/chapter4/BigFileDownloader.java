package com.planning.learnbook.multilthreading.chapter4;

import com.planning.utils.Debug;
import com.planning.utils.Tools;
...
public class BigFileDownloader {
    ...
    public BigFileDownloader(String strURL) throws Exception {
        ...
        // 获取待下载资源的大小
        fileSize = acquireFileSize(requestURL);
     ...
     */
    private long acquireFileSize(URL requestURL) throws Exception {
        long size = -1;
        ...
        try {
            ...
            String cl = conn.getHeaderField("Connect-Length");
